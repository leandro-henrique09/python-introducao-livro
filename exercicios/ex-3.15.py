...
# Esse exercicio não compreendi a lógica de como fazer, por isso não coloquei minha resposta.
# Aprendi baseado no gabarito para entender como funcionaria os cálculos.